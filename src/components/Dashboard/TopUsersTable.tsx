  ...
  if (error) {
    return (
      <div className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-5">
        ...
        <SectionErrorState message="Unable to load top users." onRetry={onRetry} />
      </div>
    );
  }
      ...
      <div>
        ...
        <div className="flex justify-between items-center px-5 py-4 border-b border-slate-100">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-base font-bold text-slate-900">Top Users</h3>
          </div>
          <button
              ...
              <tbody className="divide-y divide-slate-100">
                {users.map((user, index) => {
                  ...
                  const fullName =
                    ...
                    "Unnamed User";
                  const businessName = user.businessName?.trim() || "N/A";
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="py-2.5 px-4 text-right font-bold text-slate-900">
                        {formatIndianCurrency(user.totalSale)}
                      </td>
                    </tr>
                  );
                })}
